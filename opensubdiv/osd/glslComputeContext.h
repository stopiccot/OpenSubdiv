...
public:
    ...
    ///                              interpolation
    ///
    static OsdGLSLComputeContext * Create(Far::StencilTables const * vertexStencilTables,
...
protected:
    ...
    explicit OsdGLSLComputeContext(Far::StencilTables const * vertexStencilTables,
